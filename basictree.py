...
def parse_basictree_tree(file_path):
...
def main():
    file_name = input("Enter the name of the .bas language file to load: ")

    try:
        tree = parse_basictree_tree(file_name)
        print("\nParsed basic language Tree:")
        print(tree)
